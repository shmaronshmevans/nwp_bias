...
def run_script_recursively(
    ...
    command = [
        ...
        "/home/aevans/nwp_bias/src/machine_learning/src/xLSTM/fsdp_switchboard.py",  # Path to your main script
        "--batch_size",
        str(batch_size),
        "--station",
        station,
    ...
    for f in np.arange(1, 10):
        for s in stations:
            run_script_recursively(
                ...
                model_path=f"/home/aevans/nwp_bias/src/machine_learning/data/parent_models/HRRR/xLSTM/{c}_xLSTM.pth",
            )
