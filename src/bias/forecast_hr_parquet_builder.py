...
def make_dirs(year, month, day, fh):
    if not os.path.exists(f"/home/aevans/ai2es/lstm/fh_{fh}/{year}/"):
        os.makedirs(f"/home/aevans/ai2es/lstm/fh_{fh}/{year}/")
    if not os.path.exists(f"/home/aevans/ai2es/lstm/fh_{fh}/{year}/{month}/"):
        os.makedirs(f"/home/aevans/ai2es/lstm/fh_{fh}/{year}/{month}/")
...
def main(start_date, end_date, fh):
    ...
    while start_date <= end_date:
        ...
        the_df.to_parquet(
            f"/home/aevans/ai2es/lstm/fh_{fh}/{year}/{month}/{year}{month}{day}_hrrr_fh{fh}.parquet"
        )
...
results = pool.apply(
    main, args=(datetime(2022, 1, 1, 0, 0, 0), datetime(2022, 12, 31, 23, 59, 59), "10")
)
